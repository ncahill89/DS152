...
(i) How many observations are in the dataset? __[2 Mark]__

  - 902,297


(ii) Assume you want to create the summary below, which sums up the number of fatalities within each event type and then arranges by the total fatalities, in descending order. __[8 Marks]__
...
In the code below, what should [A] and [B] be replaced with to create the filtered dataet? __[4 Marks]__
...
In the code below, what should [A], [B] and [C] be replaced with to create the plot? __[6 Marks]__
