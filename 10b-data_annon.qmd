...
> Make each person **indistinguishable** from at least $k-1$ others in a dataset.
...
- **Homogeneity attack**: if all $k$ rows have same sensitive value, identity is inferred.
