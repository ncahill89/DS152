...
**(e)** Suppose you would like to predict, based on the attributes, whether the tumour was benign or malignant. Why would *linear* regression be unsuitable in this case?
