...
- e.g. data mining, predictive modelling, machine learning
- Involves the analysis of current and historical facts to make predictions about the future or otherwise unknown events
...
We have studied linear regression. We will now study regression trees. Again, we will not look at the mathematics in detail, the objectives are to understand how they work and be able to interpret the results.
...
__Recall that we split our data. we can use the same split again__
...
___Now fitting a regression tree___
