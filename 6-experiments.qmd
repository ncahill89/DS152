...
-   For each individual or observational unit, we measure an outcome Y, which may be continuous (e.g., income, blood pressure) or categorical (e.g., disease status, vote choice).
