...
__Note for tutors:__ You don't need to co through all the code for creating the predictions etc here just focus on how to do the calculations from the confusion tables. 
...
__Note for tutors:__ Talk through the code here for part (e) as knn is a little different to the other methods in how the code is formatted. 
